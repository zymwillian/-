$(function () {
    ...
    $(".change3 .b").click(function (e) {
        ...
        // console.log(title);
        let img = $(this).parent().prev().prev().prev().prev().parent().parent().prev().children(".sta").children("img").attr("src");
        //    console.log(img);

        let pp = $(this).parent().prev().prev().children(".price1").children(".new").text();
       let price=pp.slice(1,pp.length-1)
        let oldprice = $(this).parent().prev().prev().children(".price1").children(".old").text();
